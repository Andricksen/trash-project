...
$user=Fuser::getUserById($_GET['idUser']);
?>
<div class="main">
    <form action="controllers/alterUser.php" method="post">
        ...
        <div class="container">
            ...
            <input value="<?=$user['code'];?>" type="text" placeholder="Enter Code User" name="code" required>

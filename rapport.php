...
$historic=Fhistoric::getAllHistoricCollection();
        ...
        <table class="fl-table">
            ...
            <?php foreach($historic as $k => $data):?>
                <tr>
                    ...
                    <td><?=Fuser::checkIfIsContractorUser(Fuser::getIdPart($data['idUser']))!=''?Fuser::checkIfIsContractorUser(Fuser::getIdPart($data['idUser'])):'User';?></td>
